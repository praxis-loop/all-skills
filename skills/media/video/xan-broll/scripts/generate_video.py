#!/usr/bin/env python3
# Adapted from gbro-collage-broll (https://github.com/pyang5166/gbro-collage-broll)
# Copyright (c) 2026 狗哥笔记 — MIT License. Modified for xanskills/xan-broll:
# auto-wire certifi so urllib downloads work inside plain venvs on macOS.
"""
...
# macOS venv 常见坑:urllib 缺证书链导致视频下载 CERTIFICATE_VERIFY_FAILED。
# SDK 走 httpx 自带 certifi 不受影响,这里把 certifi 接给 urllib。
